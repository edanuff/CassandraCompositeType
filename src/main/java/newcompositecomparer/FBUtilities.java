...
public class FBUtilities {
	...
	public static byte[] hash(String type, ByteBuffer... data) {
		...
		try {
			...
			for (ByteBuffer block : data) {
				messageDigest.update(block.array(),
	...
	/*
	 * TODO how to make this work w/ ReducingKeyIterator? public static <T
	 * extends Comparable<T>> CollatingIterator getCollatingIterator() { //
	 * CollatingIterator will happily NPE if you do not specify a comparator
	 * explicitly return new CollatingIterator(new Comparator<T>() { public int
	 * compare(T o1, T o2) { return o1.compareTo(o2); } }); }
	 */
		...
		if (range.left.compareTo(range.right) >= 0) {
			...
			Comparator<DecoratedKey> comparator = new Comparator<DecoratedKey>() {
				...
				public int compare(DecoratedKey o1, DecoratedKey o2) {
					if (((right.compareTo(o1.token) < 0) && (right
							.compareTo(o2.token) < 0))
							|| ((right.compareTo(o1.token) > 0) && (right
									.compareTo(o2.token) > 0))) {
	...
	public static String resourceToFile(String filename)
	 ...
	 * constructor. TODO: Similar method for our 'instance member' singleton
